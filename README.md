...
| Layer | Technologies |
|---|---|
| **Model Training** | Python, TensorFlow / Keras, CNN (Convolutional Neural Network) |
| **Image Processing** | OpenCV, NumPy, Pillow |
| **Backend / API** | Python (Flask) |
| **Frontend** | HTML, CSS, JavaScript (or React, depending on implementation) |
| **Dataset Handling** | Pandas, scikit-learn (train/test split, evaluation metrics) |
...
- Python 3.9+
- pip
- A trained model file (`.h5` or `.pkl`) — see [Model](#-model-details) section

### 1. Clone the repository
```bash
git clone https://github.com/<your-username>/disease-diagnosis-nail-image.git
...
| Detail | Description |
|---|---|
| **Architecture** | Convolutional Neural Network (custom or transfer learning, e.g. MobileNetV2/ResNet) |
| **Input** | RGB nail image, resized to a fixed input shape (e.g. 224×224) |
| **Output** | Predicted disease class + confidence percentage |
| **Training Data** | Labeled nail image dataset, categorized by condition |
